...
var Sizzle =
    ...
    (function(window) {
      var i, support, Expr, getText, isXML, tokenize, compile, select,
          ...
          rheader = /^h\d$/i, rnative = /^[^{]+\{\s*\[native \w/,
      ...
      isXML = Sizzle.isXML = function(elem) {
        ...
        return !rhtml.test(namespace || (docElem && docElem.nodeName) ||
                           "HTML");
      };
        ...
        return markFunction(function(seed, results, context, xml) {
          var temp, i, elem,
              ...
              matcherIn = preFilter && (seed || !selector)
                              ...
                              : elems,
              matcherOut =
                  matcher // If we have a postFinder, or filtered seed, or
...
jQuery.cssHooks
    .marginLeft = addGetHookIf(support.reliableMarginLeft, function(elem,
                                                                    computed) {
  if (computed) {
    return (
        (parseFloat(curCSS(elem, "marginLeft")) ||
         elem.getBoundingClientRect().left -
             swap(elem, {marginLeft : 0},
                  function() { return elem.getBoundingClientRect().left; })) +
        "px");
  }
});
